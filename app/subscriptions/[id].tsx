import { View, Text, ScrollView, Image, Pressable, TextInput, Alert, TouchableOpacity } from 'react-native'
            ...
            <ScrollView className="flex-1 bg-white">
                ...
                <View className='p-4'>
                    ...
                    <View className="flex-row justify-between gap-6 py-5">
                        ...
                        >
                            <Text className="text-lg font-grotesk-bold text-[#121516]">Cancel Subscription</Text>
                        </Pressable>
                        <Pressable
                            className="flex-1 h-14 rounded-full items-center justify-center bg-[#f1f3f4]"
                            onPress={handleServiceRequest}
                        >
                            <Text className="text-lg font-grotesk-bold text-[#121516]">Service Request</Text>
                        </Pressable>
                    </View>
                </View>
                ...
                <ActionSheet ref={serviceActionSheetRef}>
                    <View className="p-6">
                            ...
                            <>
                                ...
                                <View className="gap-3 mb-6">
                                    {['Filter Replacement', 'Maintenance', 'Technical Support', 'Installation'].map((serviceType) => (
                                        ...
                                        >
                                            <Text className={`text-lg font-grotesk-bold ${
                                                selectedServiceType === serviceType ? 'text-white' : 'text-[#121516]'
                                            }`}>
                                                {serviceType}
                                            </Text>
                                        </Pressable>
                                ...
                                <View className="flex-row gap-3">
                                    ...
                                    <Pressable
                                        className={`flex-1 h-12 rounded-full items-center justify-center ${
                                            selectedServiceType ? 'bg-[#4fa3c4]' : 'bg-[#e5e7eb]'
                                        }`}
                                        onPress={handleServiceNext}
                                        disabled={!selectedServiceType}
                                    >
                                        <Text className={`text-lg font-grotesk-bold ${
                                            selectedServiceType ? 'text-white' : 'text-[#687b82]'
                                        }`}>
                                            Next
                                        </Text>
                                    </Pressable>
                        ...
                        {serviceStep === 2 && (
                            <>
                                ...
                                <View className="flex-row gap-3">
                                    ...
                                    <Pressable
                                        className={`flex-1 h-12 rounded-full items-center justify-center ${
                                            serviceDescription.trim() ? 'bg-[#4fa3c4]' : 'bg-[#e5e7eb]'
                                        }`}
                                        onPress={handleServiceNext}
                                        disabled={!serviceDescription.trim()}
                                    >
                                        <Text className={`text-lg font-grotesk-bold ${
                                            serviceDescription.trim() ? 'text-white' : 'text-[#687b82]'
                                        }`}>
                                            Next
                                        </Text>
                                    </Pressable>
